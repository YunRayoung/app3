...
%>
			...
			<nav>
				<ul class="pagination justify-content-center">
					...
					<a href="list.jsp?page=<%=pageNo - 1%>"class="page_link">이전</a>
					</li>
<%
	for (int num = pagination.getBeginPage(); num <= pagination.getEndpage(); num++) {
%>
					<li class="page-item<%=pageNo == num ? "active" : "" %>">
					<a href="list.jsp?page=<%=num %>" class="page_link"><%=num %></a>
					</li>
<%
	}
%>
					...
					<a href="list.jsp?page=2" class="page_link">2</a>
					</li>
					<li class="page-item">
					<a href="list.jsp?page=3" class="page_link">3</a>
					</li>
					<li class="page-item">
					<a href="list.jsp?page=4" class="page_link">4</a>
					</li>
					<li class="page-item">
					<a href="list.jsp?page=5" class="page_link">5</a>
					</li>
					-->
					
					
					<li class="page-item <%=pageNo >= pagination.getTotalPages() ? "disabled" : ""%>">
					<a href="list.jsp?page=<%=pageNo + 1%>"class="page_link">다음</a>
					</li>
